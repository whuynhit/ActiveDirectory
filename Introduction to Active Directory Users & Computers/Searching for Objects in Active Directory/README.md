...
### Or we can click Actions > Find at the top.
...
### You can see that the Find tool can filter searches by users, computers, printers, shared folders, and OUs.
...
### You may also filter search by domain if you have another domain controller setup.
...
### The following is an example of searching for a computer named "Client1."
...
### The following is an example of searching for a User named "Jason Bourne."
...
### Through the find tool, right-clicking a User from the search results will allow you make changes to the User. Changes such as resetting the password. 
...
### At the top, View > Advanced Features will enable more advanced features in Active Directory Users and Computers.
...
### One notable advanced feature is to the ability to show the path of an object in the object's properties.
...
### The following is a demonstration of using the find tool to find a computer object and moving it to another OU.
